...
-- Create app_role enum and user_roles infra
...
-- Lock down contact_submissions: revoke broad grants, only allow anon INSERT
...
-- Same for partner_submissions
REVOKE ALL ON public.partner_submissions FROM anon, authenticated;
GRANT INSERT ON public.partner_submissions TO anon, authenticated;
...
CREATE POLICY "Admins can delete partner submissions"
